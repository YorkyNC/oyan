...
class RoleTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      title: Text(role, style: const FigmaTextStyles().typography2Regular.copyWith(color: context.colors.black)),
      subtitle: Text(
        subTitle,
        style: const FigmaTextStyles().typography1Regular.copyWith(color: context.colors.gray600),
      ),
      trailing:
          isSelected
              ? Icon(
