...
import 'package:oyan/src/features/events/presentation/components/events_app_bar.dart';
                ...
                SliverToBoxAdapter(
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: context.typography.typography2Regular.copyWith(color: context.colors.gray500),
                    ),
                  ),
                ),
                SliverList(
                      ...
                      return Material(
                        ...
                        borderRadius:
                            index == events.length - 1
                                ...
                                : null,
                        child: ReviewEventTile(onTap: () {}, event: events[index]),
                      );
                    },
