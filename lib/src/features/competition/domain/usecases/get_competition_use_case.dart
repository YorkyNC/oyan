...
@lazySingleton
class GetCompetitionUseCase extends UseCase<GetCompetitionEntity, GetCompetitionRequest> {
  final ICompetitionRepository _repository;

  GetCompetitionUseCase(@Named.from(CompetitionRepositoryImpl) this._repository);

  @override
  Future<Either<DomainException, GetCompetitionEntity>> execute(GetCompetitionRequest requestModel) {
    return _repository.getCompetition(requestModel);
  }
}
