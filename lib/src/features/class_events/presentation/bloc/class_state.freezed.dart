...
abstract class $ClassStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<ClassEntity>? classes, int sortColumnIndex, bool sortAscending});
}
...
class _$ClassStateImpl implements _ClassState {
  ...
  @override
  String toString() {
    return 'ClassState(classes: $classes, sortColumnIndex: $sortColumnIndex, sortAscending: $sortAscending)';
  }
...
abstract class _ClassState implements ClassState {
  factory _ClassState(
      {final List<ClassEntity>? classes,
      final int sortColumnIndex,
      final bool sortAscending}) = _$ClassStateImpl;
