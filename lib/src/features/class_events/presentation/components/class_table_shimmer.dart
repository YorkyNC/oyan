...
class ClassTableShimmer extends StatelessWidget {
  const ClassTableShimmer({Key? key}) : super(key: key);
                ...
                child: Row(
                  ...
                  children: [
                    const Column(
                      ...
                      children: [
                        ShimmerContainer(isEight: true, width: 119, height: 24),
                        SizedBox(height: 4),
                        ShimmerContainer(isEight: true, width: 76, height: 18),
                      ],
                    ),
                    Row(
                      children: [
                        const ShimmerContainer(isEight: true, width: 44, height: 18),
