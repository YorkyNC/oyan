  ...
  void didUpdateWidget(covariant ReviewAnalyticsIndicatorView oldWidget) {
    ...
    if (value != oldWidget.value) {
      if (value == null) {
        ...
        _controller.animateTo(math.min(value / _maxValue, 1), duration: const Duration(seconds: 1));
      }
    }
      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children: [
              SizedBox(width: 52, height: 52, child: SvgPicture.asset(widget.assetPath)),
              const SizedBox(height: 12),
              Text(widget.title, style: context.typography.typography1Regular.copyWith(color: const Color(0xFF6E7178))),
