...
import 'package:oyan/src/core/widgets/tab_bar/custom_tab_item.dart';
...
class CustomTabSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: const Color(0xFFF8FAFC), borderRadius: BorderRadius.circular(12.0)),
      child: Stack(
        children: <Widget>[
          AnimatedContainer(
